...
const sections = [
  {
    ...
    content:
      "Guyana Digital School provides educational content, courses, and resources through our online platform. We reserve the right to modify or discontinue any aspect of our services at any time. To access certain features, you may be required to create an account. You are responsible for maintaining the confidentiality of your account credentials and agree to notify us of any unauthorized use.",
  },
  {
    icon: Shield,
    title: "Intellectual Property",
    content:
      "All content provided on this site, including but not limited to text, images, videos, and software, is the property of Guyana Digital School or its licensors. Unauthorized reproduction or distribution is prohibited.",
  },
  {
    icon: AlertTriangle,
    title: "Limitation of Liability",
    content:
      "Guyana Digital School is not liable for any direct, indirect, incidental, or consequential damages resulting from your use of our services. We do not guarantee uninterrupted access to our platform.",
  },
  {
    icon: Scale,
    title: "Governing Law",
    content:
      "These terms are governed by the laws of Guyana. Any disputes arising from the use of our services shall be resolved in the courts of Guyana.",
  },
  {
    icon: RefreshCw,
    title: "Changes to Terms",
    content:
      "We reserve the right to update these terms at any time. Any changes will be effective immediately upon posting on our website.",
  },
];

const TermsAndConditions = () => {
  useEffect(() => {
    document.title = "Terms & Conditions | Guyana Digital School";
  }, []);
      ...
      <section className="gradient-navy pt-28 pb-16 md:pt-36 md:pb-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center">
          ...
          <p className="text-primary-foreground/60 max-w-2xl mx-auto text-sm md:text-base leading-relaxed">
            Welcome to Guyana Digital School. By accessing our website and using our services, you agree to abide by these terms and conditions.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
          ...
          <div className="mt-12 text-center">
            <blockquote className="text-lg md:text-xl font-display italic text-foreground/70 border-l-4 border-secondary pl-6 inline-block text-left">
              "Guyana Digital School — where education meets innovation for a brighter tomorrow."
            </blockquote>
          </div>
        </div>
      </section>
